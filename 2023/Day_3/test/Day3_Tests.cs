namespace Herbert.AdventOfCode.Y2023.Day3.Tests;
...
public class Day3_Tests
{
    ...
    {
        var puzzle = new Day3();
        var (Puzzle1, _) = await puzzle.Solve(input);

        Assert.Equal("4361", Puzzle1);
    }
    ...
    public async Task Solve_Puzzle_PartOneBigInput(string input)
    {
        var puzzle = new Day3();
        var (Puzzle1, Puzzle2) = await puzzle.Solve(input);

        Assert.Equal("554003", Puzzle1);
    }
